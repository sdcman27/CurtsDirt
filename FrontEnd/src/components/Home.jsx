  ...
  <div>
    ...
    <p className="legend">ShakenTopsoil</p>
      ...
      <div className="home-about">
        <h1>About Us</h1>
        <p>
        &nbsp;&nbsp;&nbsp;&nbsp;Welcome to the family at Curt's Dirt, where every grain of soil is steeped in a legacy of care and quality.<br></br><br></br>

        &nbsp;&nbsp;&nbsp;&nbsp;Founded in 2020, Curt's Dirt is more than just a business—it's a passion that has blossomed into a promise of excellence. Operating individually, yet fueled by the spirit of family, we are your neighbors, dedicating every day to fulfilling your needs and nurturing growth, both in your gardens, land and in our relationships.<br></br><br></br>

        &nbsp;&nbsp;&nbsp;&nbsp;Our journey began with a simple mission: to offer a product that stands the test of time and to provide a service that makes every customer feel like part of the Curt's Dirt family. It is with a shovel in hand and a heart full of dedication that we venture into each day, committed to the hard work that has become the foundation of our reputation.<br></br><br></br>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;At Curt's Dirt, we're not just selling topsoil; we're offering a promise—a promise to be there for our customers, to listen and to adapt, ensuring that you remain satisfied with our products and our service. Because for us, it's not just about making a sale; it's about building a lasting relationship and becoming the trusted partner you deserve.<br></br><br></br>

        &nbsp;&nbsp;&nbsp;&nbsp;So, let's plant the seeds for a beautiful tomorrow together. At Curt's Dirt, your growth is our success, and your satisfaction is our legacy.<br></br><br></br>

        &nbsp;&nbsp;&nbsp;&nbsp;<b>Welcome to quality. Welcome to efficiency. Welcome to Curt's Dirt.</b>
        </p>
      </div>
